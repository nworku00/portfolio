    ...
    <section className="h-screen bg-red-950 overflow-x-hidden">
      <div className="px-8 lg:px-32 flex flex-col justify-center align-between">
        <h1 className="text-6xl mt-64 font-bold tracking-wide text-orange-200">
          Hi, my name is  
          <span className="ml-3 bg-gradient-to-r from-orange-300 to-red-400 bg-clip-text text-transparent">
         {hero.name}
          </span>
        </h1>
        <h1 className="text-5xl font-bold tracking-wide mt-4 text-orange-200">{hero.subtitle}</h1>
